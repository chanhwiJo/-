						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" disabled value="<%=uDTO.getUser_name()%>" style="background-color: white">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="bmd-label-floating">ID</label>
												<input type="text" class="form-control" disabled value="<%=uDTO.getUser_id()%>" style="background-color: white">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" disabled value="<%=uDTO.getGender()%>" style="background-color: white">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="bmd-label-floating">지역</label>
												<input type="text" class="form-control" disabled value="<%=local[0]%> <%=local[1]%>" style="background-color: white">
											</div>
										</div>
									</div>
									<div class="row">
									...
									<button type="button" class="btn btn-success pull-right" id="reset">리스트로 이동</button>
									<%if(uDTO.getAuth().equals("UD")) {%>
										<button type="button" onclick="dojoinD(<%=jDTO.getUser_no() %>);"
											class="btn btn-success pull-right" style="width: 100px">거 절</button>
										<button class="btn btn-success pull-right" onclick="doapprove(<%=jDTO.getUser_no() %>);"
