...
<body id="page-top">
	...
	<!-- find_password -->
	<section class="content-section" id="find_password">
		<div class="container" style="width: 30%">
			<div class="content-section-heading text-center">
				<h3 class="text-secondary mb-0">Find Password</h3>
				<h2 class="mb-5">비밀번호 찾기</h2>
				<div class="card card-login mx-auto mt-5">
					<div class="card-header">Find Password</div>
					<div class="card-body">
						<form style="color: black;" method="post" action="solution.do" onsubmit="return doSubmit(this);">
